...
All notable changes to BriefLint are documented here.
...
- Deterministic preflight engine with evidence-backed result states
- Safe, data-only preflight pack import and export
